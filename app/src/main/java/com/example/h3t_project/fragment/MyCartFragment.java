...
public class MyCartFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences preferences = this.getActivity().getSharedPreferences("mycart", Context.MODE_PRIVATE);
        ...
        MyCartAdapter myCartAdapter = new MyCartAdapter(getContext(), products, totalPrice);
